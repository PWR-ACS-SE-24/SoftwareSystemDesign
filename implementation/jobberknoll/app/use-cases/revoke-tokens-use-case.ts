...
type RevokeTokensUseCaseReq = { accountId: UUID };

export class RevokeTokensUseCase extends UseCase<RevokeTokensUseCaseReq, void, AccountNotFoundError> {
  public constructor(
    logger: Logger,
  ...
  protected async handle(
    ctx: Ctx,
    { accountId }: RevokeTokensUseCaseReq,
