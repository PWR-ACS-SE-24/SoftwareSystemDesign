...
- `LOG/05` - Jako _kierowca_ chcę mieć możliwość zgłaszania i edycji _awarii_, aby informować _pasażerów_ o problemach na _kursie_.
- `LOG/06` - Jako _bileter_ chcę mieć możliwość zgłaszania i edycji _awarii_, aby informować _pasażerów_ o problemach na _kursie_.
...
[Prototypy w figmie](https://www.figma.com/proto/w096uheLN6Tqg5gNMnfgR1/PSI?node-id=1-3&node-type=canvas&t=a8LjVIVgtqFtams4-0&scaling=min-zoom&content-scaling=fixed&page-id=1%3A3)
