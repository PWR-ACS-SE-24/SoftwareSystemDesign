...
- `TIC/08` - Jako _pasażer_ chcę mieć możliwość zobaczenia  _kodu biletu_.
- `TIC/09` - Jako _pasażer_ chcę mieć możliwość zobaczenia _okresu ważności biletu_.
- `TIC/10` - Jako _pasażer_ chcę mieć możliwość zobaczenia _typu biletu_.
- `TIC/11` - Jako _pasażer_ chcę mieć możliwość zobaczenia _zakresu biletu_.
- `TIC/12` - Jako _pasażer_ chcę mieć możliwość zobaczenia _ceny biletu_.
- `TIC/13` - Jako _pasażer_ chcę mieć możliwość _skasowania biletu_.
- `TIC/14` - Jako _pasażer_ chcę mieć możliwość okazania _biletu_ do _sprawdzenia ważności biletu_.
- `TIC/15` - Jako _pasażer_ chcę mieć możliwość zobaczenia _oferty biletów_.
- `TIC/16` - Jako _pasażer_ chcę mieć możliwość zobaczenia historii zakupionych _biletów_.
- `TIC/17` - Jako _bileter_ chcę mieć możliwość _sprawdzenia ważności_ _biletu_ _pasażera_.
