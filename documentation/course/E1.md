...
- `PAY/02` - Jako _pasażer_ chcę mieć możliwość dodania metody płatności BLIK do swojego _konta_.
- `PAY/03` - Jako _pasażer_ chcę mieć możliwość dodania nowej karty płatniczej.
- `PAY/04` - Jako _pasażer_ chcę mieć możliwość usunięcia karty płatniczej ze swojego _konta_.
- `PAY/05` - Jako _pasażer_ chcę mieć możliwość usunięcia metody płatności ze swojego _konta_.
- `PAY/06` - Jako _pasażer_ chcę mieć możliwość wyboru BLIK jako metodę płatności.
- `PAY/07` - Jako _pasażer_ chcę mieć możliwość wyboru karty płatniczej jako metodę płatności. 
- `PAY/08` - jako _pasażer_ chcę mieć możliwość dodania środków do swojego _portfela_.
- `PAY/09` - jako _pasażer_ chcę mieć możliwość sprawdzenia stanu swojego _portfela_.
- `PAY/10` - jako _pasażer_ chcę mieć możliwość przeglądania historii doładowań _portfela_.
- `PAY/11` - jako _pasażer_ chcę mieć możliwość przeglądania historii płatności.
- `PAY/12` - jako _pasażer_ chcę mieć możliwość zapłaty za _bilet_ za pomocą BLIK.
- `PAY/13` - jako _pasażer_ chcę mieć możliwość zapłaty za _bilet_ za pomocą karty płatniczej.
- `PAY/14` - jako _pasażer_ chcę mieć możliwość zapłaty za wystawiony _mandat_ za pomocą BLIK.
- `PAY/15` - jako _pasażer_ chcę mieć możliwość zapłaty za wystawiony _mandat_ za pomocą karty płatniczej.
- `PAY/16` - jako _pasażer_ chcę mieć możliwość zmiany _statusu mandatu_ na _opłacony_.
- `PAY/16` - jako _pasażer_ chcę mieć możliwość przeglądania wystawionych _mandatów_.
- `PAY/17` - jako _pasażer_ chcę mieć możliwość wyświetlenia szczegółów _mandatu_.
- `PAY/18` - jako _bileter_ chcę mieć możliwość wystawienia _mandatu_.
- `PAY/19` - jako _bileter_ chcę mieć możliwość zmiany _statusu mandatu_ na _anulowany_
- `PAY/20` - jako _bileter_ chcę mieć możliwość przeglądania historii _mandatów_.
...
- `REG/06/15` - Status mandatu może przyjmować wartości: opłacony, nieopłacony, anulowany. 
- `REG/06/15` - Status mandatu jest domyślnie nieopłacony.
- `REG/06/16` - Status mandatu zmienia się na opłacony po uregulowaniu opłaty.
- `REG/06/17` - Status mandatu zmienia się na anulowany po anulowaniu mandatu przez biletera.
