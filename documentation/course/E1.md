...
- `TIC/12` - Jako _pasażer_ chcę mieć możliwość _skasowania biletu_.
- `TIC/13` - Jako _pasażer_ chcę mieć możliwość okazania _biletu_ do _sprawdzenia ważności biletu_.
- `TIC/14` - Jako _pasażer_ chcę mieć możliwość zobaczenia _oferty biletów_.
- `TIC/15` - Jako _pasażer_ chcę mieć możliwość zobaczenia historii zakupionych _biletów_.
- `TIC/16` - Jako _bileter_ chcę mieć możliwość _sprawdzenia ważności_ _biletu_ _pasażera_.
