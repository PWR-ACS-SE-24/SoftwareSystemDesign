...
- `PAY/16` - jako _bileter_ chcę mieć możliwość wystawienia _mandatu_.
- `PAY/17` - jako _bileter_ chcę mieć możliwość anulowania _mandatu_.
- `PAY/18` - jako _bileter_ chcę mieć możliwość przeglądania historii _mandatów_.
