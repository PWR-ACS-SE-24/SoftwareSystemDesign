...
classDiagram
    ...
    class EkranZakupuBiletu { <<ServerPage>> }
...
classDiagram
    ...
    class EkranDodawaniaKarty { <<ServerPage>> }
...
classDiagram
    direction LR
    class EkranBiletów { <<ServerPage>> }
    class EkranDoladowaniaPortfela { <<ServerPage>> }
    class MetodaPlatnosciDropdown { <<Component>> }
...
### Wymaganie 4 (Piotr Kot)

1. `PAY/13` - jako _pasażer_ chcę mieć możliwość zapłaty za _bilet_ za pomocą _portfela_.
