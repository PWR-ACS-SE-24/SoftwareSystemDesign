...
| **Blik**                        | _blik_                | System płatności mobilnych, który pozwala na dokonywanie płatności za pomocą kodu 6 cyfrowego kodu.                              |
| **Czas ważności**               | _duration_            | Czas od _skasowania_, przez który _bilet czasowy_ jest _ważny_.                                                                  |
| **Dane karty kredytowej**       | _credit card info_    | Informacje o karcie kredytowej, które pozwalają na dodanie karty do konta.                                                       |
...
- `PAY/02` - Jako _pasażer_ chcę mieć możliwość dodania nowej karty płatniczej.
- `PAY/03` - Jako _pasażer_ chcę mieć możliwość usunięcia karty płatniczej ze swojego _konta_.
- `PAY/04` - Jako _pasażer_ chcę mieć możliwość wyboru BLIK jako metodę płatności.
- `PAY/05` - Jako _pasażer_ chcę mieć możliwość wyboru karty płatniczej jako metodę płatności.
- `PAY/06` - Jako _pasażer_ chcę mieć możliwość wyboru portfela jako metody płatności. 
...
- `PAY/11` - jako _pasażer_ chcę mieć możliwość zapłaty za _bilet_ za pomocą BLIK.
- `PAY/12` - jako _pasażer_ chcę mieć możliwość zapłaty za _bilet_ za pomocą karty płatniczej.
- `PAY/13` - jako _pasażer_ chcę mieć możliwość zapłaty za _bilet_ za pomocą portfela.
...
- `PAY/16` - jako _pasażer_ chcę mieć możliwość zapłaty za wystawiony _mandat_ za pomocą portfela.
