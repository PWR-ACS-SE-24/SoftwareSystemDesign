...
2. `TIC/07` - Jako _pasażer_ chcę mieć możliwość wyświetlenia szczegółów zakupionego _biletu_.

#### Mapa nawigacyjna

#### Prototypy ekranów

- `TIC/06` - Przeglądanie zakupionych biletów.

![TIC/06](images/Ticket1.png)

- `TIC/07` - Przeglądanie szczegółów biletu.
...
- `TIC/10` - Przeglądanie oferty biletów.
...
1. `TIC/12` - Jako _bileter_ chcę mieć możliwość _sprawdzenia ważności_ _biletu_ _pasażera_.

#### Mapa nawigacyjna

#### Prototypy ekranów

- `TIC/12` - Sprawdzenie ważności biletu.
...
1. `LOG/05` - Przeglądanie listy przystanków.

![LOG/05](images/Stop1.png)

2. `LOG/06` - Dodawanie przystanku.

![LOG/06](images/Stop2.png)

3. `LOG/07` - Edycja przystanku.

![LOG/07](images/Stop3.png)

4. `LOG/08` - Usuwanie przystanku.
